...
// pokedexes.js/collections.js's own copies of this function (cards has its
// own dedicated script instead of the shared collections.js).
...
document.getElementById("export-items").addEventListener("click", async () => {
    ...
    await exportJsonFile(activeDeck.jsonFile, data, undefined, snapshotData, idToken);
});
